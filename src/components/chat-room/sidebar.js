...
export default function Sidebar() {
  ...
  return (
    ...
    <div className={`lg:hidden ${isOpenRoomMenu ? 'z-20' : null} fixed h-full bg-blue-600 w-72 transform -translate-x-[17.8rem] text-white px-2 py-2 border-r-2 border-black chat-menu`}>
      <RenderingRoomModal/>
