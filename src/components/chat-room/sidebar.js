...
export default function Sidebar() {
  ...
  return (
    <div className="z-10 bg-white dark:bg-[#161C2D]">
    ...
    <div className={`lg:hidden ${isOpenRoomMenu ? 'z-20' : null} bg-white dark:bg-[#161C2D] fixed h-full w-72 transform -translate-x-[17.8rem] px-2 py-2 border-r-2 border-black chat-menu`}>
      <RenderingRoomModal/>
