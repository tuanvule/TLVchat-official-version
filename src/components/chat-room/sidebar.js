...
export default function Sidebar() {
  ...
  return (
    <div className="z-10">
    <div className="lg:block hidden h-full bg-[#0A0C10] w-72 text-white px-2 py-2 ">
      <RenderingRoomModal/>
    </div>
    ...
    <div className={`lg:hidden ${isOpenRoomMenu ? 'z-20' : null} fixed h-full bg-[#0A0C10] w-72 transform -translate-x-[17.8rem] text-white px-2 py-2 border-r-2 border-black chat-menu`}>
      <RenderingRoomModal/>
